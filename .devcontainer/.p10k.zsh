# Generated by Powerlevel10k configuration wizard on 2024-10-21 at 11:31 KST.
...
() {
  ...
  if grep -qa 'docker\|lxc' /proc/1/cgroup || [ -f /.dockerenv ]; then
    export ZSH_ENV_TYPE="🐳 %178FCont %250F\u2502 "
  else
    export ZSH_ENV_TYPE="💻 %76FHost %250F\u2502 "
  fi

  typeset -g POWERLEVEL9K_DIR_PREFIX=${ZSH_ENV_TYPE}
